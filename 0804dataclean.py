...
location = pd.read_csv('Nice_Ride_2016_station_locations.csv')
...
history['Total duration (seconds)'].describe()
history['Total duration (min)'] = history['Total duration (seconds)'] / 60
